...
\begin{center}
\begin{tikzpicture}
\draw ( -6,-1) -- (-6,-1) node [near start, below]{\tiny Bias in $S$:};
\draw (-6,-2) -- (2,-2);
\draw ( 0,-2.2) -- ( 0,-1.8) node [near start, below]{$P = \hat{P}$}; 
\draw (-5,-2.2) -- (-5,-1.8) node [near start, below]{$S$};
\draw (-3,-2.2) -- (-3,-1.8) node [near start, below]{$\hat{S}$};
\draw[red, very thick] (-5,-2) -- (-3,-2) node [midway, above]{};

\draw ( -6,1) -- (-6,1) node [near start, below]{\tiny Bias in $P$:};
\draw (-6,0) -- (2,0);
\draw ( 0,-0.2) -- ( 0,0.2) node [near start, below]{$P$}; 
\draw (-5,-0.2) -- (-5,0.2) node [near start, below]{$S = \hat{S}$};
